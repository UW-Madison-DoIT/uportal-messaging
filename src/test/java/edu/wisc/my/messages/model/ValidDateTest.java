...
public class ValidDateTest {
  ...
  public void filterOutImproperDates() {
    ...
    MessageFilter filter = new MessageFilter();
    message.setFilter(filter);
    filter.setGoLiveDate(nonsenseDate);
  ...
  public void expiringLaterTodayIsNotExpired() throws InterruptedException {
    ...
    filter.setExpireDate(twoSecondsLaterThanNow.toString());
    filter.setGoLiveDate("1900-01-01T03:00");
